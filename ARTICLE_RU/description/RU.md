...
short: Пошаговая инструкция как сделать робота работающего на Raspberry Pi 4, ROS и C++
date: 2021-04-07
...
В этой статье мы на примере расскажем о том как создать настоящего робота работающего и полностью построенного на инфракструктуре ROS. Это будет наш первый простой робот со своей операционной системой.
